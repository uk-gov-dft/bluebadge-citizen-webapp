...
public class SaveAndReturnCodeMessageRequest extends GenericMessageRequest {
  private SaveAndReturnCodeMessageRequest(String template, String emailAddress, Map<String, ?> attributes) {
  ...
  public SaveAndReturnCodeMessageRequest(String emailAddress, String code, String expiryTime) {
    super("SAVE_AND_RETURN", emailAddress, ImmutableMap.of("returnCode", code, "expiryTime", expiryTime));
  }
}
