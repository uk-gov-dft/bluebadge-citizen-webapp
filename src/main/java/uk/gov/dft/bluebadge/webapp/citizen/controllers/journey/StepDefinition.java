...
public enum StepDefinition {
  ...
  HEALTH_CONDITIONS(WHAT_WALKING_DIFFICULTIES,ARMS_HOW_OFTEN_DRIVE, DECLARATIONS, HEALTHCARE_PROFESSIONAL_LIST),
  PROVE_BENEFIT(DECLARATIONS),
  CONTACT_DETAILS(PROVE_BENEFIT, HEALTH_CONDITIONS, DECLARATIONS),
