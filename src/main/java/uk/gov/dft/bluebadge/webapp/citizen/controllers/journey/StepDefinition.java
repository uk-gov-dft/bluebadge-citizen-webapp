...
public enum StepDefinition {
  ...
  REGISTERED_COUNCIL(DECLARATIONS),
  PERMISSION(REGISTERED_COUNCIL, DECLARATIONS),
  REGISTERED(PERMISSION, DECLARATIONS),
  HEALTHCARE_PROFESSIONAL_LIST(DECLARATIONS),
  ...
  ARMS_DIFFICULTY_PARKING_METER(DECLARATIONS),
  ARMS_DRIVE_ADAPTED_VEHICLE(ARMS_DIFFICULTY_PARKING_METER),
  ARMS_HOW_OFTEN_DRIVE(ARMS_DRIVE_ADAPTED_VEHICLE),
  HEALTH_CONDITIONS(
      WHAT_WALKING_DIFFICULTIES, ARMS_HOW_OFTEN_DRIVE, DECLARATIONS, HEALTHCARE_PROFESSIONAL_LIST),
  PROVE_BENEFIT(DECLARATIONS),
  CONTACT_DETAILS(PROVE_BENEFIT, HEALTH_CONDITIONS, DECLARATIONS, REGISTERED),
