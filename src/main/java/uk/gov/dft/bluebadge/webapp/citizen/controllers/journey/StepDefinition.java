...
public enum StepDefinition {
  ...
  WHERE_CAN_YOU_WALK(DECLARATIONS),
  HEALTH_CONDITIONS(DECLARATIONS, WHERE_CAN_YOU_WALK),
  CONTACT_DETAILS(HEALTH_CONDITIONS),
  ...
  // Main reason journey
  WALKING_DIFFICULTY(WHERE_CAN_YOU_WALK, MAY_BE_ELIGIBLE, NOT_ELIGIBLE),
  CONTACT_COUNCIL(),
