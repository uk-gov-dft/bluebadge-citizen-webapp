...
public enum StepDefinition {
  SUBMITTED(),
  PAY_FOR_THE_BADGE(SUBMITTED),
  PAY_FOR_THE_BADGE_RETRY(SUBMITTED),
  PAY_FOR_THE_BADGE_RETURN(SUBMITTED, PAY_FOR_THE_BADGE, PAY_FOR_THE_BADGE_RETRY),
  DECLARATIONS(PAY_FOR_THE_BADGE, SUBMITTED),
