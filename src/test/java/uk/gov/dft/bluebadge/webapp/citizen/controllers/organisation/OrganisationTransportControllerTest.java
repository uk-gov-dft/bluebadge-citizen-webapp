...
public class OrganisationTransportControllerTest {

  private MockMvc mockMvc;
  private OrganisationTransportController controller;
  ...
  void setup() {
    ...
    controller = new OrganisationTransportController(mockRouteMaster);
    mockMvc =
