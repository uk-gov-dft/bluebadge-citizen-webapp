...
public class DisabilityControllerTest {
    ...
    public void setup() {
        ...
        journey.setApplicantForm(ApplicantForm.builder()
                .applicantType(YOURSELF.name()).build());

        journey.setCompensationSchemeForm(CompensationSchemeForm.builder()
                .hasReceivedCompensation(true).build());
    ...
    public void show_ShouldDisplayDisabilityTemplate_WithRadioOptions() throws Exception {
        RadioOptionsGroup options = new RadioOptionsGroup("afcs.disabilityPage.title")
                .autoPopulateBooleanOptions();

        DisabilityForm form = DisabilityForm.builder().build();

        mockMvc.perform(get("/permanent-and-substantial-disability")
    ...
    public void submit_ShouldDisplayErrors_WhenNoOptionsAreSelected() throws  Exception {
        ...
        mockMvc.perform(post("/permanent-and-substantial-disability")
                .param("hasDisability", ""))
