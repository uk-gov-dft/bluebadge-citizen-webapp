...
public class MainReasonControllerTest {
  ...
  public void setup() {
    ...
    MainReasonController controller = new MainReasonController(mockRouteMaster);
    mockMvc =
        MockMvcBuilders.standaloneSetup(controller)
            .setViewResolvers(new StandaloneMvcTestViewResolver())
            .build();
    journey = JourneyFixture.getDefaultJourneyToStep(StepDefinition.MAIN_REASON, EligibilityCodeField.CHILDBULK);
  ...
  public void submit_givenValidForm_thenShouldDisplayRedirectToSuccess() throws Exception {
    ...
    when(mockRouteMaster.redirectToOnSuccess(any(MainReasonForm.class)))
