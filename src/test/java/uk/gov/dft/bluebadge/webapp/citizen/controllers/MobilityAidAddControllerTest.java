...
public class MobilityAidAddControllerTest {
  ...
  @Before
  public void setup() {
    MobilityAidAddController controller =
        new MobilityAidAddController(RouteMasterFixture.routeMaster());
    mockMvc =
    ...
    mockMvc
        ...
        .andExpect(
            request()
                .sessionAttribute(
                    "JOURNEY",
                    Matchers.hasProperty("walkingAid", Matchers.equalTo("withWalkingAid."))));
  }
