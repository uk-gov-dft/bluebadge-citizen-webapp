...
public class ApplicantControllerTest {
  ...
  public void setup() {
    ...
    when(buildProperties.getVersion()).thenReturn("v0.55.0");
    ...
    cookieManager = Mockito.spy(new RedirectVersionCookieManager(redisConfig, buildProperties));
  ...
  public void
    ...
    mockMvc
        ...
        .andExpect(cookie().exists(APP_VERSION_COOKIE_NAME))
