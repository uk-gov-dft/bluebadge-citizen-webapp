...
class OrganisationMayBeEligibleControllerTest {
  ...
  void setup() {
    ...
    OrganisationMayBeEligibleController controller = new OrganisationMayBeEligibleController(mockRouteMaster);
    mockMvc =
        MockMvcBuilders.standaloneSetup(controller)
            .setViewResolvers(new StandaloneMvcTestViewResolver())
            .build();
    journey = new JourneyBuilder().inEngland().forOrganisation().toStep(ORGANISATION_MAY_BE_ELIGIBLE).build();
