...
public class OrganisationMayBeEligibleControllerTest {

  private MockMvc mockMvc;
  private OrganisationMayBeEligibleController controller;
  ...
  void setup() {
    ...
    controller = new OrganisationMayBeEligibleController(mockRouteMaster);
    mockMvc =
