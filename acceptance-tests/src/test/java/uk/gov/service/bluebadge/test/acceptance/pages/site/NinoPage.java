...
public class NinoPage {
  ...
  public static final String VALIDATION_MESSAGE_FOR_EMPTY_NINO = "National Insurance number must be in the correct format";
  public static final String VALIDATION_MESSAGE_FOR_INVALID_NINO  = "National Insurance number must be in the correct format";
