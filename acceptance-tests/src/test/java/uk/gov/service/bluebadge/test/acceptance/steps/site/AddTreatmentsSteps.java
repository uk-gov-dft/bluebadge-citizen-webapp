...
public class AddTreatmentsSteps extends AbstractSpringSteps {
    ...
    private void validateInvalidEntries() {
        ...
        commonPage.findPageElementById(AddTreatmentsPage.TREATMENT_DESCRIPTION).sendKeys(AddTreatmentsPage.INVALID_TEXT);
        commonPage.findPageElementById(AddTreatmentsPage.TREATMENT_WHEN).click();
        commonPage.findPageElementById(AddTreatmentsPage.TREATMENT_WHEN).sendKeys(AddTreatmentsPage.VALID_WHEN);
        commonSteps.iVerifyValidationMessage(AddTreatmentsPage.VALIDATION_MESSAGE_FOR_INVALID_DESCRIPTION);

        //To validate am invalid When
        commonPage.findPageElementById(AddTreatmentsPage.TREATMENT_DESCRIPTION).click();
        commonPage.findPageElementById(AddTreatmentsPage.TREATMENT_DESCRIPTION).clear();
        commonPage.findPageElementById(AddTreatmentsPage.TREATMENT_DESCRIPTION).sendKeys(AddTreatmentsPage.VALID_DESCRIPTION);
        commonPage.findPageElementById(AddTreatmentsPage.TREATMENT_WHEN).click();
        commonPage.findPageElementById(AddTreatmentsPage.TREATMENT_WHEN).sendKeys(AddTreatmentsPage.INVALID_TEXT);
    ...
    public void iCompleteAddTreatmentsPage() {
        commonPage.clearAndSendKeys(AddTreatmentsPage.TREATMENT_DESCRIPTION, AddTreatmentsPage.VALID_DESCRIPTION);
