...
public class AddHealthcareProfessionalSteps extends AbstractSpringSteps {
    ...
    private void validateInvalidEntries() {
        ...
        commonPage
                .findPageElementById(AddHealthcareProfessionalPage.Location)
                .sendKeys(AddHealthcareProfessionalPage.INVALID_TEXT);
        commonSteps.iVerifyValidationMessage(AddHealthcareProfessionalPage.VALIDATION_MESSAGE_FOR_INVALID_LOCATION);
    }
    ...
    public void iCompleteAddHealthcareProfessionalPage() {
        ...
        commonPage.clearAndSendKeys(AddHealthcareProfessionalPage.Location, AddHealthcareProfessionalPage.VALID_LOCATION);
        commonSteps.iClickOnAddButtonOnChildPage(AddHealthcareProfessionalPage.HC_PROFESSIONAL_ADD_BUTTON);
    }
}
