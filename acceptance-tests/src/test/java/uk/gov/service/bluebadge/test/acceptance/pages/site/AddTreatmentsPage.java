...
public class AddTreatmentsPage {
  ...
  public static final String VALIDATION_MESSAGE_FOR_EMPTY_TREATMENT_DESCRIPTION = "Enter treatment description";
  public static final String VALIDATION_MESSAGE_FOR_EMPTY_TREATMENT_WHEN = "Enter when treatment was received";
