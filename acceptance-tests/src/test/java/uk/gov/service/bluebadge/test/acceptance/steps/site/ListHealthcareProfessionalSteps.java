...
public class ListHealthcareProfessionalSteps extends AbstractSpringSteps {
  ...
  public ListHealthcareProfessionalSteps(CommonPage commonPage, CommonSteps commonSteps) {
    ...
    this.addHealthcareProfessionalSteps = new AddHealthcareProfessionalSteps(commonPage, commonSteps);
  }
  ...
  public void iValidateTheHealthcareProfessionalsPage(String applicant, String option) {
    ...
    if ("YES".equals(option)) {
      commonPage.selectRadioButton(ListHealthcareProfessionalPage.HEALTHCARE_PROFESSIONAL_YES_OPTION);
      commonPage.findPageElementById(ListHealthcareProfessionalPage.HEALTHCARE_PROFESSIONAL_YES_OPTION).click();
      commonPage.findPageElementById(ListHealthcareProfessionalPage.ADD_FIRST_HEALTHCARE_PROFESSIONAL).click();
      addHealthcareProfessionalSteps.iValidateAddHealthcareProfessionalPage();
    } else {
      commonPage.selectRadioButton(ListHealthcareProfessionalPage.HEALTHCARE_PROFESSIONAL_NO_OPTION);
    }
  ...
  public void verifyPageContent(String applicant) {
    ...
    if ("yourself".equals(applicant.toLowerCase())) {
      commonSteps.thenIShouldSeePageTitledWithGovUkSuffix(ListHealthcareProfessionalPage.PAGE_TITLE);
