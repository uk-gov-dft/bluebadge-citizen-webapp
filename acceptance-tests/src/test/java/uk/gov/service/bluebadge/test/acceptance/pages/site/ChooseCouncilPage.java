...
public class ChooseCouncilPage{
  ...
  public static final String PAGE_LABEL_1_YOURSELF = "You cannot get a Blue Badge if you live outside of the UK.";
  public static final String PAGE_LABEL_1_SOMEONE_ELSE = "They cannot get a Blue Badge if they live outside of the UK.";

  public static final String PAGE_LABEL_2 = "You'll need to apply through direct.gov if your council isn't listed.";
  ...
  public static final String DO_NOT_KNOW_COUNCIL_LINK = "https://www.gov.uk/blue-badge-scheme-information-council";
