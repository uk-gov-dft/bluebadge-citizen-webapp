...
public class ContactDetailsPage {
  ...
  public static final String VALIDATION_MESSAGE_FOR_CONTACT_FULL_NAME =
      "Enter contact\'s full name";

  public static final String VALIDATION_MESSAGE_FOR_INVALID_MAIN_PHONE_NUMBER =
      "Main contact number must be in the correct format";
