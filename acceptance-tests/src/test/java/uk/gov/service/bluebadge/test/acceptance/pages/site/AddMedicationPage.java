...
public class AddMedicationPage {
  ...
  public static final String VALIDATION_MESSAGE_FOR_EMPTY_DOSAGE =
      "Enter a dosage that is 100 characters or less";
  public static final String VALIDATION_MESSAGE_FOR_EMPTY_PRESCRIBED =
      "Select whether this has been prescribed";
  public static final String VALIDATION_MESSAGE_FOR_EMPTY_NAME =
      "Enter a name that is 100 characters or less";
  public static final String VALIDATION_MESSAGE_FOR_EMPTY_FREQUENCY =
      "Enter a frequency that is 100 characters or less";
